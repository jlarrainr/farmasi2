...
$sql = "SELECT invnum  FROM venta  WHERE estado=0 and invtot<> bruto and invfec='2021-09-13'    ORDER BY invnum  ";
//$sql = "SELECT invnum,igv  FROM venta WHERE invnum='1024040' and estado=0 ORDER BY invnum ";
...
if (mysqli_num_rows($result)) {
    while ($row = mysqli_fetch_array($result)) {
        ...
        $sql1 = "UPDATE venta set valven = '$mont3',igv = '$mont4',invtot = '$mont5',bruto = '$mont5',saldo = '$mont5',gravado = '$SumGrabado',inafecto = '$SumInafectos',icbper_total='$icbpertotal',icbpertotal='$icbpertotal'  where invnum = '$invnumventa'";
         mysqli_query($conexion, $sql1);
