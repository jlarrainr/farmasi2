...
<table width="100%" border="0">
  ...
  <iframe src="ingresos2.php?marca=<?php echo $marca?>&val=<?php echo $val?>" name="marco" id="marco" width="100%" height="520" scrolling="Automatic" frameborder="0" allowtransparency="0">
  </iframe>
</body>
</html>
