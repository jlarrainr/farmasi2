...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <div class="tabla1">
            ...
            <div class="title1">
                ...
                <table width="100%" border="0">
                    <tr>
                        <td align="left">
                            <span class="titulos">AUDITOR DE VALIDACIONES</span>
                        </td>
   ...
   <!--<td align="right"><a href="http://www.farmasis.site/" target="_blank"><img src="../../css/FARMASIS.png" width="210" height="32"  /> </a></td>-->
            ...
            <div class="mask1111">
                <div class="mask2222">
                    <div class="mask3333">
                        <iframe src="validacion1.php" name="principal" width="100%" height="600" scrolling="Automatic" frameborder="0" id="principal" allowtransparency="0">
                        </iframe>
                    </div>
                </div>
            </div>
