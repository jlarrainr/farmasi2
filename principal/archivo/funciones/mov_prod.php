...
<script>
    ...
    function verificarFactorLleno()
    {
        if(document.form1.factor.value.length === 0)
        {
            document.getElementById('npreuni').disabled = true;
            document.getElementById('nprevta').disabled = true;
        }
        else 
        {
            document.getElementById('npreuni').disabled = false;
            document.getElementById('nprevta').disabled = false;
        }
    }
    ...
    function precioblister() {
        ...
        //alert(npreblister + " , " + nfactor);
        margenblister2 = Math.abs(((((npreblister * nfactor) / 100) - 1) * 100));
        //alert(margenblister2);
    ...
    function prods(e) {
        ...
        if (tecla == 114) {
            ...
            document.form1.cod_generico.disabled = false;
            ...
            document.form1.covid.disabled = false;
            document.form1.activoPuntos.disabled = false;
            document.form1.icbper.disabled = false;
            document.form1.recetaMedica.disabled = false;
        ...
        if (tecla == 119) {
            ...
            if (f.save.disabled == false) {
                ...
                // if ((f.categoria.value == "") || (f.categoria.value == 0)) {
    ...
    function sf() {
        ...
        document.form1.cod_generico.disabled = true;
        ...
        document.form1.covid.disabled = true;
        document.form1.activoPuntos.disabled = true;
        document.form1.icbper.disabled = true;
        document.form1.recetaMedica.disabled = true;
    ...
    function buton2() {
        document.getElementById("tablaProductos").style.display = "block";
         var drogueria = parseFloat(document.form1.drogueria.value);
        var selva = parseFloat(document.form1.selva.value);
        ...
        if (selva == 1) {
            document.form1.igv.disabled = true;
            document.form1.igv.checked = false;
        ...
        if (drogueria == 1) {
            document.form1.lotec.disabled = true;
            document.form1.lotec.checked = true;
        } else {
            document.form1.lotec.disabled = false;
            document.form1.lotec.checked = false;
        }
        document.form1.covid.disabled = false;
        document.form1.covid.checked = false;  
        document.form1.activoPuntos.disabled = false;
        document.form1.activoPuntos.checked = false;
        document.form1.icbper.disabled = false;
        document.form1.icbper.checked = false;
        document.form1.recetaMedica.disabled = false;
        document.form1.recetaMedica.checked = false;
        document.form1.textdesc.disabled = false;
        document.form1.rd.disabled = false;
        document.form1.rd1.disabled = false;
        ///	botones
        ...
        document.form1.cod_generico.value = "";
        ...
        var catx = document.form1.categoria.value;
    ...
    function validar() {
        ...
        if ((f.cod_generico.value > 0)) {
            if (f.cod_bar.value == 0) {
                alert("Registro Codigo Generico, debe Marcar si este producto es parte del Listado COVID-19");
