...
<body>
	<div class="tabla1">
		...
		<div class="mask1111" style="background-color: #f9f9f9;">
			<div class="mask2222" style="background-color: #ececec;">
				<div class="mask3333" style="background-color: #dfdfdf;">
					<iframe src="ocompra1.php" name="principal" width="100%" height="660" scrolling="Automatic" frameborder="0" id="principal" allowtransparency="0">
					</iframe>
				</div>
			</div>
		</div>
