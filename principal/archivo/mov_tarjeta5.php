...
<br>
<?php $id	= $_REQUEST['cod'];	
$sql="SELECT id,nombre FROM tarjeta where id = '$id'";
...
<table width="570" align="center" class="demoTable">
      <caption>
        <span class="Estilo1">MODIFICAR  TARJETA        </span>
      </caption>
      <thead>
        <tr>
        ...
        <tr>
          <td colspan="2"><div align="center">
              ...
              <div align="right">
                ...
                <input type="button" name="back" value="Regresar" onClick="atras_movtransp5()" class="regresar"/>
      ...
      <tbody>
        ...
        <tr>
		  ...
		  <center>
	        <div align="right">
	          <input name="desc" type="text" id="desc" size="75" onkeyup="this.value = this.value.toUpperCase();" value="<?php echo $nombre?>" onFocus="blur()" />
	          <input type="button" name="Submit" value="Eliminar" onclick="del_movtabla5()" class="grabar"/>
            </div>
		  </center></td>
        </tr>
