...
<?php require_once("funciones/mov_tarjeta.php");?>
...
<table width="570" align="center" class="demoTable">
        <caption>
        <span class="Estilo1">LISTADO DE TARJETAS
		<b>
		<?php if ($error == '1')
		{ 
		?>
		...
		{ 
		?>
		<font color="#FFFF66">- SE LOGRO ACTUALIZAR LA TARJETA SELECCIONADO</font>
		<?php } 
		If ($del ==1)
		{ 
		?>
		<font color="#FFFF66">- SE LOGRO ELIMINAR LA TARJETA INDICADO</font>
		<?php } 
		?>
		</b>        </span>
        </caption>
      ...
      <tbody>
	  <?php $i=0;
	  $sql="SELECT id,nombre FROM tarjeta order by nombre";
	  ...
	  ?>
        <tr>
		  ...
		  <td><center>
		  <a href="mov_tarjeta4.php?cod=<?php echo $id?>"><img src="../../images/edit_16.png" border="0" height="14" width="14"/></a>
		  </center></td>
		  <td><center>
		  <a href="mov_tarjeta5.php?cod=<?php echo $id?>"><img src="../../images/del_16.png" border="0" width="14" height="14" /></a>
		  </center></td>
        </tr>
	  <?php }
      } 
