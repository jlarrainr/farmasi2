...
<body onload="getfocus();" id="body" onkeyup="foco(event)">
	...
	?>
						...
						<td>
							<table width="100%" border="0" align="center">
								<tr>
									...
									<td width="79" class="text_combo_select">
										<div align="right"><strong>BLISTER</strong></div>
									</td>
									<td width="130" class="text_combo_select">
										<div align="right"><strong>TOT DE STOCK ACTUAL </strong></div>
									</td>
									<td width="129" class="text_combo_select">
										<div align="right"><strong>TOT DE STOCK MINIMO </strong></div>
									</td>
									<td width="94" class="text_combo_select">
										<div align="right"><strong>FALTANTE</strong></div>
									</td>
								</tr>
							</table>
						</td>
									...
									<tr <?php if ($codpro == $cod_prod) { ?>bgcolor="#FFFF99" <?php } else { ?> onmouseover="this.style.backgroundColor='#EAEDEF';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';" <?php } ?>>
										...
										<td width="444">
											...
											<a id="l<?php echo $cr; ?>" href="javascript:popUpWindow('stockmin3.php?codpro=<?php echo $codpro ?>&country_ID=<?php echo $marca ?>&val=1&ccr=<?php echo $cr ?>', 40, 90, 920, 360)">
												<font size="3"><?php if ($codpro == $cod_prod) { ?><b><?php echo $desprod ?></b><?php } else {
																																echo $desprod;
																															} ?></font>
											</a> </td>
										<td width="79">
										...
										<td width="130">
											<div align="right"><?php echo $div ?> F <?php echo $tot ?></div>
										</td>
										<td width="129">
											<div align="right">
		...
		?>
			...
			<center>NO SE LOGRO ENCONTRAR PRODUCTOS CON LA MARCA INDICADA</center>
	<?php }
