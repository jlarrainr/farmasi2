...
<body <?php if (($val == 0) && ($marca == "")) { ?>onload="sf()" <?php } ?>>
  <form name="form1" id="form1" onClick="highlight(event)" onKeyUp="highlight(event)">
    <table width="100%" border="0">
      <tr>
        <td width="944">
          <table width="100%" border="0">
            <tr>
              <td width="58" class="LETRA">MARCA</td>
              <td>
          ...
          <table width="100%" border="0">
            <tr>
              ...
              <td width="189">
                <div align="right"><span class="blues"><b>USUARIO:</b> <?php echo $user ?></span></div>
              </td>
            </tr>
          </table>
    ...
    <table width="100%" border="0" class="tabla2">
      <tr>
        <td width="954"><iframe src="stockmin2.php?val=<?php echo $val ?>&marca=<?php echo $marca ?>&codpro=<?php echo $codpro ?>&cr=<?php echo $cr ?>" name="iFrame1" width="100%" height="525" scrolling="Automatic" frameborder="0" id="iFrame1" allowtransparency="0"> </iframe></td>
      </tr>
    </table>
  </form>
</body>
