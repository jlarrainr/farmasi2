		...
		<div class="mask1111">
			<div class="mask2222">
				<div class="mask3333">
					...
					?>
					<iframe src="stockmin1.php?activado=<?php echo $activado ?>&activado1=<?php echo $activado1 ?>&tipo=<?php echo $tipo ?>&val=<?php echo $val ?>&producto=<?php echo $producto ?>" name="mark" width="100%" height="600" scrolling="Automatic" frameborder="0" id="mark" allowtransparency="0"> </iframe>
				</div>
			</div>
		</div>
	</div>
