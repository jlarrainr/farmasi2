          ...
          <td colspan="2">
            <div align="center">
              ...
              <div align="right">
                ...
                <input type="button" name="back" value="Regresar" onClick="atras_movlocal5()" class="regresar" />
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <center>
              <div align="right">
                <input name="desc" type="text" id="desc" size="75" onkeyup="this.value = this.value.toUpperCase();" value="<?php echo $nomloc ?>" onFocus="blur()" />
