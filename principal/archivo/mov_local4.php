...
<body onLoad="st();">
  <br>
  <?php $codloc  = $_REQUEST['cod'];
  $sql = "SELECT codloc,nomloc FROM local where codloc = '$codloc'";
  ...
  <form name="form1" id="form1">
    <table width="100%" align="center" class="demoTable">
      <caption>
        <span class="Estilo1">MODIFICAR LOCALES </span>
      </caption>
      <thead>
        <tr>
          <th width="77">
          ...
          <td colspan="2">
            <div align="center">
              ...
              <div align="right">
                ...
                <input type="button" name="back" value="Regresar" onClick="atras_movlocal4()" class="regresar" />
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <center>
              <div align="right">
                <input name="desc" type="text" id="desc" size="75" onKeyUp="this.value = this.value.toUpperCase();" value="<?php echo $nomloc ?>" />
                <input type="button" name="Submit" value="Grabar" onclick="save_movlocal4()" class="grabar" />
              </div>
            </center>
          </td>
        </tr>
