...
<div class="title1">
<span class="titulos"> CODIGO DE LA EMPRESA  
</span></div>
<div class="mask1111">
	<div class="mask2222">
		<div class="mask3333">
			<iframe src="exdigimed2.php" name="principal" width="355" height="150" scrolling="Automatic" frameborder="0" id="principal" allowtransparency="0">
			</iframe>
  	  </div>
	</div>
   </div>
