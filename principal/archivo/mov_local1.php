...
<table width="570" align="center" class="demoTable">
        <caption>
        <span class="Estilo1">LISTADO DE LOCALES
		<b>
		<?php if ($error == '1')
		{ 
		?>
		...
		{ 
		?>
		<font color="#FFFF66">- SE LOGRO ACTUALIZAR EL LOCAL SELECCIONADO</font>
		<?php } 
		If ($del ==1)
		{ 
		?>
		<font color="#FFFF66">- SE LOGRO ELIMINAR EL LOCAL INDICADO</font>
		<?php } 
		?>
		</b>        </span>
        </caption>
          ...
          <td colspan="4"><div align="center">
            <form method="post" name="form1" id="form1">
              <div align="right">
                ...
                <input type="submit" name="nuevo2" value="Regresar" onclick="back_movlocal1()" class="regresar"/>
                <input type="submit" name="nuevo" value="Nuevo" onClick="nuevo_movlocal1()" class="nuevo"/>
      ...
      <tbody>
	  <?php $i=0;
	  $sql="SELECT codloc,nomloc FROM local order by nomloc";
	  ...
	  ?>
        <tr>
		  ...
		  <td><center>
		  <a href="mov_local4.php?cod=<?php echo $codloc?>"><img src="../../images/edit_16.png" border="0" height="14" width="14"/></a>
		  </center></td>
		  <td><center>
		  <a href="mov_local5.php?cod=<?php echo $codloc?>"><img src="../../images/del_16.png" border="0" width="14" height="14" /></a>
		  </center></td>
        </tr>
	  <?php }
      } 
