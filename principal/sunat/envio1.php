...
////////////////////////////
    ...
    <body onload="st();">
        <table width="100%" border="0">
            <tr>
                <td>
                    <b>ENVIO DE FACTURAS Y BOLETAS A SUNAT</b>
                    <br/>
                          ...
                          <td><input type="button" value="Salir" onclick="salir()" class="salir"></td>
                            ...
                            <tr>
                                <td colspan="9" style="color:red">
                                    <b>NOTA: </b>Una vez enviado todos los comprobantes, hacer click en "Comunicar Bajas" para enviar los documentos anulados y culminar el proceso.
                                </td>
                            </tr>
                        </table>
                        <br/>
...
<!--                                    <th width="65px">Anulado Sistema</th>-->
                                    <th width="65px">Anulado Sunat</th>                                    
                ...
                if (date.length > 0 && sucursal.length > 0) {
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            $('#cpe-anulados').html(response.anulados);
