		...
		<form id="form1" name="form1" onKeyUp="highlight(event)" onClick="highlight(event)">
			...
			<table class="celda2" width="100%">
				...
				while ($row = mysqli_fetch_array($result)) {
					...
					$sqlMovlote = "SELECT numerolote,vencim FROM templote where invnum = '$invnum' AND codpro = '$codpro'";
					$resultMovlote = mysqli_query($conexion, $sqlMovlote);
					if (mysqli_num_rows($resultMovlote)) {
						while ($rowMovlote = mysqli_fetch_array($resultMovlote)) {
							$numerolote1     = $rowMovlote['numerolote'];
							$vencim1     = $rowMovlote['vencim'];
						}
					}
				...
				?>
					...
					<tr onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';">
						...
						<td valign="bottom">
							<div align="center"><?php echo $numerolote1 ?></div>
						</td>
						<td valign="bottom">
							<div align="center"><?php echo $vencim1 ?></div>
						</td>
						<td valign="bottom">
							<div align="center">
