...
<form name="form1" id="form1">
  ...
  <tr>
    ...
    <td width="54%"><?php echo fecha($fecha)?></td>
	<td><div align="right">N Documento <?php echo $numdoc;?></div></td>
	</tr>
</table>
<table width="98%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="11%">Local de:</td>
    <td width="20%"><?php echo $nombre1?></td>
    <td width="6%"><div align="left">Local a: </div></td>
    <td width="63%"><?php echo $nombre?></td>
  </tr>
</table>
<table width="98%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="11%">Doc. Referencia  </td>
    <td width="46%">INGRESO POR TRANSFERENCIA  </td>
...
<?php 
$i = 0;
	$sql1="SELECT * FROM movmov where invnum = '$invnum' order by orden";
	$result1 = mysqli_query($conexion,$sql1);
	if (mysqli_num_rows($result1)){
	while ($row1 = mysqli_fetch_array($result1)){
	$i++;
