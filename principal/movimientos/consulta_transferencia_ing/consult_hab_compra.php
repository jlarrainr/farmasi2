...
if (mysqli_num_rows($result)) {
	while ($row = mysqli_fetch_array($result)) {
		...
		mysqli_query($conexion, "UPDATE movlote set stock ='$cant_local' where idlote = '$numlote'");
		/////////////////////////////////////////////////////////////
		mysqli_query($conexion, "INSERT INTO kardex (nrodoc,codpro,fecha,tipmov,tipdoc,qtypro,fraccion,factor,invnum,usecod,sactual,sucursal, eliminado,numlote) values ('$numdoc','$codpro','$fechaActual','1','2','$qtypro','$qtyprf','$factor','$cod','$usuario','$sactual','$sucursal','2','$numlote')");
	}
}
mysqli_query($conexion, "UPDATE movmae set val_habil = 'O' ,estado='1' where invnum = '$cod'");
mysqli_query($conexion, "UPDATE movmae set val_habil = '0' ,estado='1' where invnum = '$invnumrecib'");
