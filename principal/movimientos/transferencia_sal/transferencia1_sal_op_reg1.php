...
<script>
function cargar() {
    window.open('pre_imprimir.php?rd='+ <?php echo $rd?>,'PopupName','toolbar=0,location=0,status=0,menubar=0,scrollbars=1,resizable=0,top=60,left=120,width=885,height=630');
}
</script>
</head>
<body onload="cargar();">
