...
<div class="title1">
<span class="titulos">FARMASIS - TRANSFERENCIA A SUCURSALES
</span></div>
<div class="mask1111">
	<div class="mask2222">
		<div class="mask3333">
			<iframe src="transferencia1_sal.php" name="tranf_principal" width="100%" height="725" scrolling="Automatic" frameborder="0" id="tranf_principal" allowtransparency="0">
			</iframe>
  	  </div>
	</div>
   </div>
