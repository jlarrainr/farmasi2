...
// if (($localrecargado != '') || ($localrecargado != '')) {
// 	mysqli_query($conexion, "UPDATE movmae set sucursal1 ='$localrecargado '  where invnum = '$invnum'");
// }
...
<head>
	...
	<script>
		...
		function grabarventa() {
			...
			//alert("wwwwwwwwww");
			window.open('preimprimir.php?numdocreg=' + doc + '&referencia=' + referencia + '&local=' + local + '&vendedor=' + vendedor + '&mont2=' + mont2 + '&cod=' + cod, 'PopupName', 'toolbar=0,location=0,status=0,menubar=0,scrollbars=1,resizable=0,top=60,left=120,width=1200,height=560');
		}
	</script>
			...
			<tr>
				<td width="958">
					<!-- <table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="10%" class="LETRA" align="left">CARGAR PREPEDIDO</td>
							<td width="22%">
								<input name="prepedido" type="text" id="prepedido" size="17" value="<?php echo $idpreped; ?>" />
								<input type="submit" name="Prepedido" value="Buscar" onclick="prepedido1()" class="buscar" />
								<input type="submit" name="VerPrepedido" value="Ver" onclick="verPrepedido()"   class="imprimir" />
							</td>
							<td width="10%" class="LETRA">NUMERO INTERNO<?php echo $lastVentaId ?></td>
							<td width="10%"><input name="textfield" type="text" size="26" disabled="disabled" value="<?php echo formato($numdoc) ?>" /></td>
							<td width="10%" class="LETRA">
								<div align="left">FECHA</div>
							</td>
							<td width="15%"><input name="textfield2" type="text" size="22" disabled="disabled" value="<?php echo fecha($fecha) ?>" /></td>
              ...
              <input name="modif" type="button" id="modif" value="Modificar" class="modificar" disabled="disabled"/>-->
						...
						<tr>
							...
							<td width="868" colspan="5">
								<input name="referencia" type="text" id="referencia" size="139" onkeyup="cargarContenido()" value="<?php echo $refere; ?>" placeholder="Debe ingresar el nombre del transportista ...." /></td>
					...
					?>
						...
						<table width="55%" border="0" bgcolor="#fde5d2" align="center" id="datos" cellpadding="0" cellspacing="0">
							<tr>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="955">
								<iframe src="transferencia3_sal.php" name="iFrame2" width="100%" height="350" scrolling="Automatic" frameborder="0" id="iFrame2" allowtransparency="0"> </iframe>
							</td>
						</tr>
					</table>
					<br><br><br>
					...
					<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="80">&nbsp;</td>
							<td width="125">
								<div align="right" class="LETRA">COSTO DE PRODUCTOS</div>
							</td>
							<td width="113">
								<div align="right">
