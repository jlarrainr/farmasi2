...
<head>
    ...
    <script>
        ...
        //             popUpWin.close();
        //     }
        //     popUpWin = open('pendientes.php', 'popUpWin', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,minimizable = no, resizable=no,copyhistory=yes,width=455,height=700,left=540,top=300,screenX=' + left + ',screenY=' + top + '');
        // }
    </script>
    <style type="text/css">
        h1 {
        ...
        <div class="mask1111">
            <div class="mask2222">
                <div class="mask3333">
                    ...
                    <?php }?>
                    <iframe src="transferencia1_ing.php" name="ingreso_transf" width="100%" height="640" scrolling="Automatic" frameborder="0" id="ingreso_transf" allowtransparency="0">
                    </iframe>
                </div>
            </div>
        </div>
