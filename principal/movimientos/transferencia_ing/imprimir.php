...
<head>
	...
	<title><?php echo $desemp ?> - TRANSFERENCIA POR INGRESOS</title>
	<script>
		function imprimir() {
	...
	<form name="form1" id="form1">
		<table width="98%" border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td>
					<div align="right">N Documento <?php echo $numdoc; ?></div>
				</td>
			</tr>
		</table>
		<table width="98%" border="0" cellpadding="0" cellspacing="0">
		...
		?>
				<table width="98%" border="0">
					<tr>
						...
						<td width="20%"><?php if ($abrev <> "") {
											echo $abrev;
										} else {
											echo $destab;
										} ?></td>
						<td width="10%"><?php if ($qtyprf <> "") {
											echo $qtyprf;
										} else {
											echo $qtypro;
										} ?></td>
