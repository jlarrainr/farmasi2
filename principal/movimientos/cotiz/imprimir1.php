...
<body onkeyup="escapes(event)" onload="imprimir();">
	<form name="form1" id="form1">
		<table width="869" border="0" bordercolor="#666666">
			<tr>
				<td>
					<div align="center"><a href="javascript:imprimir()"><b><span class="Letras"><?php echo $descm ?></span></b></a></div>
											...
											if (mysqli_num_rows($result1)) {
												while ($row1 = mysqli_fetch_array($result1)) {
													...
													if (($zzcodloc <> 1) && ($precios_por_local == 1)) {
														...
														$sql_precio = "SELECT $costpr_p,$prelis_p,$prevta_p,$preuni_p FROM precios_por_local where codpro = '$codpro'";
