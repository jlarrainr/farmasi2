...
$sql1="SELECT cuscod,invfec,usecod,sucursal FROM venta2 where invnum = '$tventa'";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
mysqli_query($conexion,"INSERT INTO venta_nosave(invnum,invfec,cuscod,usecod,invtot,sucursal) values ('$tventa','$invfec','$cuscod','$usecod','$mont5','$sucursal')");
/////////////////////////////////////////////////////////////////////////////////////////////////////////
require_once('funciones/datos_generales.php'); //////CODIGO Y NOMBRE DEL LOCAL
$sql="SELECT codpro,canpro,fraccion,prisal,pripro,factor,codmar,bonif FROM detalle_venta2 where invnum = '$tventa'";
...
while ($row = mysqli_fetch_array($result)){
	...
	if ($bonif == 1)
	{
		$sql1="SELECT codkey,cajas FROM temp_vent_bonif where invnum = '$tventa' and codpro = '$codpro'";
		$result1 = mysqli_query($conexion,$sql1);
		if (mysqli_num_rows($result1)){
		while ($row1 = mysqli_fetch_array($result1)){
				$codkey    = $row1['codkey'];
	...
	mysqli_query($conexion,"INSERT INTO venta_nosave_detalle(invnum,codpro,canpro,fraccion,prisal,pripro,factor,codmar,codfam,coduso,invfec) values ('$tventa','$codpro','$canpro','$fraccion','$prisal','$pripro','$factor1','$codmar','$codfam','$coduso','$date')");
	if ($fraccion == "F")
	{
...
mysqli_query($conexion,"DELETE from detalle_venta2 where invnum = '$tventa'");
mysqli_query($conexion,"DELETE from temp_vent_bonif where invnum = '$tventa'");
mysqli_query($conexion,"DELETE from detalle_venta where invnum = '$tventa'");
