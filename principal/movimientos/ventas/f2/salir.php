...
$sql = "SELECT VC.fecha_pago FROM venta_cuotas AS VC INNER JOIN venta AS V on V.invnum=VC.venta_id INNER JOIN cliente AS C on C.codcli=V.cuscod WHERE V.forpag='C' and V.estado='0' and V.val_habil='0' and C.codcli = '$codcli' and VC.montoCobro>0 ORDER BY VC.fecha_pago ASC LIMIT 1  ";
//error_log($sql);
