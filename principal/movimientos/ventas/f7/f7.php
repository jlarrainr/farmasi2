...
if ($cod <> '')
{
$sql="SELECT desprod,s000,s001,s002,s003,s004,s005,s006,s007,s008,s009,s010,s011,s012,s013,s014,s015,s016,s017,s018,s019,s020 FROM producto where codpro = '$cod'";
...
<div align="center">
  ...
  <table width="565" border="0">
    ...
    <tr>
      <td>LOCAL 17 </td>
      <td><div align="right"><?php echo $s017?></div></td>
    </tr>
    <tr>
      <td>LOCAL 18 </td>
      <td><div align="right"><?php echo $s018?></div></td>
    </tr>
    <tr>
      <td>LOCAL 19 </td>
      <td><div align="right"><?php echo $s019?></div></td>
    </tr>
    <tr>
      <td>LOCAL 20 </td>
      <td><div align="right"><?php echo $s020?></div></td>
    </tr>
  </table>
</div>
<div align="center"><br>
