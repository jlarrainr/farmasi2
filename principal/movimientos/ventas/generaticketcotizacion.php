...
<body onload="imprimir()">
    <form name="form1" id="form1">
        ...
        $sqlV = "SELECT invnum,nrovent,invfec,invfec,cuscod,usecod,codven,forpag,fecven,sucursal,correlativo,nomcliente,pagacon,vuelto,bruto,hora,invtot,igv,valven,tipdoc,tipteclaimpresa,icbpertotal FROM venta where invnum = '$venta'";
            ...
            ?>
                ...
                ?>
                    <tr>
                        ...
                        <td colspan="4"><?php echo $desprod; ?></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td colspan="2"><?php echo $marca; ?></td>
                        <!--<td><?php echo $numlote; ?></td>-->
                        <td style="text-align: right"><?php echo number_format($prisal, 2, '.', ''); ?></td>
                        <td style="text-align: right"><?php echo number_format($prisal * $Cantidad, 2, '.', ''); ?></td>
                    </tr>
