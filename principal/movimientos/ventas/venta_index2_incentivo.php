...
<table width="80%" border="0" id="customers">
	...
	<th ><div align="center"><span class="Estilo3">CANTIDAD</span></div></th>
	<th ><div align="center"><span class="Estilo3">MONTO</span></div></th>
	<th ><div align="center"><span class="Estilo3">P. MINIMO</span></div></th>
	<th ><div align="center"><span class="Estilo3">CUOTA</span></div></th>
  </tr>
  <?php $i=1;
  function formato($s)
  {
  ...
  if (mysqli_num_rows($resultss)){
	while ($rowss = mysqli_fetch_array($resultss)){
		$invnum    = $rowss['invnum'];
		//editado adrian
		$sql="SELECT producto.codpro,producto.factor,desprod,canprocaj,canprounid,pripro,pripromin,cuota,codloc,codmar,codfam FROM producto 
		...
		where incentivadodet.invnum = '$invnum' and incentivadodet.estado = '1' and incentivado.estado = '1' and incentivado.esta_desa = '0'
		order by desprod";

		//and ((codloc = '$codigo_local') or (codloc = '$localp'))
		...
		if (mysqli_num_rows($result)){
			...
			<tr onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';">
			    ...
			    <td align="center"><div ><?php echo $codpro;?></div></td>
				<td ><a id="l1" href="javascript:cerrar_popup(<?php echo $codpro?>)"><?php echo $desprod?></a></td>
				
				<td ><div ><?php echo substr($mark,0,40);?></div></td>
				<td ><div align="center"><?php echo substr($class,0,50);?></div></td>
				<td ><div align="center"><?php echo $cantt; echo " "; echo $desc;?></div></td>
				<td ><div align="center"><?php echo $pripro?></div></td>
				<td ><div align="center"><?php echo $pripromin?></div></td>
