...
///CODIGO UTILIZADO PARA ELIMINAR
$venta     = $_REQUEST['cod'];        ///CODIGO UTILIZADO PARA ELIMINAR
$correo     = $_REQUEST['correo'];        ///CODIGO UTILIZADO PARA ELIMINAR
...
$sqlCli = "SELECT email FROM cliente where codcli = '$cuscod'";
...
header("Location: ventas.php?retorno=$venta&tip=1");
