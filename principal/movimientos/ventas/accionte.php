		...
		<table class="tabla2" width="442" border="0">
			<tr>
				<td width="540">
					...
					$sql = "SELECT codtab,destab FROM titultabladet where tiptab = 'U' and destab LIKE '$limpiacadena%' order by destab";
					...
					?>
						<table width="438" border="0" align="center">
							...
							while ($row = mysqli_fetch_array($result)) {
								...
								$destab         = $row['destab'];
							?>
								<tr height="30" onmouseover="this.style.backgroundColor='#FFFF99';this.style.cursor='hand';" onmouseout="this.style.backgroundColor='#ffffff';">
