...
?>
<title><?php echo $desprod?> - PREINGRESOS PENDIENTES</title>
...
<table class="tabla2" width="442" border="0">
  <tr>
    ...
    <?php $sql="SELECT invfec,nrocomp,provee,confirmado,preingreso FROM ordmae where pendiente = '1' and preingreso = '1'";
