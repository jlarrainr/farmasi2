		...
		<form id="form1" name="form1" onKeyUp="highlight(event)" onClick="highlight(event)">
			<table class="celda2" width="100%">
				<tr>
					...
					<td width="47" bgcolor="#50ADEA" class="titulos_movimientos">
						<div align="center">CANT</div>
					</td>
					<td width="208" bgcolor="#50ADEA" class="titulos_movimientos">
						<div align="center">MARCA</div>
					</td>
					<td width="54" bgcolor="#50ADEA" class="titulos_movimientos">
						<div align="center">P. PROM </div>
					</td>
					<td width="60" bgcolor="#50ADEA" class="titulos_movimientos">
