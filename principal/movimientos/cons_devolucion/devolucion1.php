...
<head>
    ...
    require_once('../funciones/devolucion_consulta.php');    //FUNCIONES DE ESTA PANTALLA
    ...
    $sql = "SELECT count(*) FROM nota where estado = '0' and tipvta = '0' AND sucursal = '$codloc'";
    $result = mysqli_query($conexion, $sql);
    if (mysqli_num_rows($result)) {
        while ($row = mysqli_fetch_array($result)) {
            $numrows             = $row[0];
    ...
    if ($tip == 1) {
        $sql = "SELECT count(*) FROM nota where estado = '0' and tipvta = '0' and invnum <= '$num'";
        $result = mysqli_query($conexion, $sql);
        if (mysqli_num_rows($result)) {
            while ($row = mysqli_fetch_array($result)) {
                $pageno             = $row[0];
        ...
        <table width="100%" border="0">
            <tr>
                <td width="938">
                    ...
                    if ($tip == 1) {
                        if (!is_numeric($num[0])) {
                            $sql = "SELECT nrofactura,invnum,invfec,cuscod,codmed,usecod,nrovent,bruto,valven,invtot,igv,forpag,val_habil,estado,hora,sucursal,correlativo,tipdoc FROM nota where (nrofactura = '$num' or invnum = '$num' ) and estado = '0' and tipvta = '0' and sucursal = '$codigo_local'";
                        } elseif ($nombre_local == 'LOCAL0') {
                            $sql = "SELECT nrofactura,invnum,invfec,cuscod,codmed,usecod,nrovent,bruto,valven,invtot,igv,forpag,val_habil,estado,hora,sucursal,correlativo,tipdoc  FROM nota where (invnum = '$num' or nrofactura = '$num') and estado = '0' and tipvta = '0' and sucursal = '$codigo_local'";
                        } else {
                            $sql = "SELECT nrofactura,invnum,invfec,cuscod,codmed,usecod,nrovent,bruto,valven,invtot,igv,forpag,val_habil,estado,hora,sucursal,correlativo,tipdoc  FROM nota where (invnum = '$num' or nrofactura = '$num') and estado = '0' and sucursal = '$codigo_local' and tipvta = '0'";
                        }
                    } else {
                        if ($nombre_local == 'LOCAL0') {
                            $sql = "SELECT nrofactura,invnum,invfec,cuscod,codmed,usecod,nrovent,bruto,valven,invtot,igv,forpag,val_habil,estado,hora,sucursal,correlativo,tipdoc FROM nota where estado = '0' and tipvta = '0' and sucursal = '$codigo_local' order by invnum asc $limit";
                        } else {
                            $sql = "SELECT nrofactura,invnum,invfec,cuscod,codmed,usecod,nrovent,bruto,valven,invtot,igv,forpag,val_habil,estado,hora,sucursal,correlativo,tipdoc  FROM nota where estado = '0' and sucursal = '$codigo_local' and tipvta = '0' order by invnum asc $limit";
                        }
                    }
                    ...
                    ?>
                        <table width="100%" border="0">
                            <tr>
                                ...
                                <td><input name="textfield" type="text" size="15" disabled="disabled" value="<?php echo formato($correlativo) ?>" /></td>
            ...
            <td  align="left">
                    ...
                    ?>
                        <table width="100%" border="0">
                            <tr>
                                <td width="955">
                                    <iframe src="devolucion2.php?invnum=<?php echo $invnum ?>" name="iFrame2" width="100%" height="290" scrolling="Automatic" frameborder="0" id="iFrame2" allowtransparency="0"> </iframe>
                                </td>
                            </tr>
                        </table>
                        <div align="center"><img src="../../../images/line2.png" width="100%" height="4" /></div>
                    ...
                    ?>
                        <table width="100%" border="0">
                            <tr>
                                <td>
                                    <iframe src="devolucion3.php" name="iFrame2" width="100%" height="420" scrolling="Automatic" frameborder="0" id="iFrame2" allowtransparency="0"> </iframe>
                                </td>
                            </tr>
                        </table>
                        <div align="center"><img src="../../../images/line2.png" width="100%" height="4" /></div>
