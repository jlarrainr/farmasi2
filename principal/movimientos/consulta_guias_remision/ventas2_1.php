...
$sqlV = "SELECT despatch_id,despatch_uid,issueDate,note,partyIdentification,partyName,deliveryCustomerAccountID,deliveryName,information,grossWeightMeasure,unitCodeWeightMeasure,totalUnitQuantity,transportModeCode,startDate,carrierPartyID,carrierPartyName,deliveryAddressId,deliveryStreetName,transportEquipmentId,originAddressId,originAddressStreetName,sucursal,invnumold,serie_doc,issuetime,tipo_afectacion FROM sd_despatch where despatch_uid='$despatch_uid'";
...
if (mysqli_num_rows($resultV)) {
    while ($row = mysqli_fetch_array($resultV)) {
        ...
        $sqlXCOM = "SELECT seriegui FROM xcompa where codloc = '$sucursal'";
...
<body onload="imprimir()">
    ...
    <?php
    require_once('impresionGuia.php');
    ?>
