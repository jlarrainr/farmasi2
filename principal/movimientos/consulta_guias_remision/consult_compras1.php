...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
            ...
            $sql = "SELECT count(despatch_uid) FROM sd_despatch where sucursal = '$codigo_local'";
...
//////////////////////////////////
            if (($numero == "") && ($pag == "")) {
                $sql = "SELECT despatch_id FROM sd_despatch where  sucursal = '$codigo_local' order by despatch_id desc limit 1";
//echo "1";
            } else {
                if (($numero == "") && ($pag <> "")) {
                    $sql = "SELECT despatch_id FROM sd_despatch where sucursal = '$codigo_local' order by despatch_id asc $limit";
                    //echo "2";
                } else {
                    $sql = "SELECT despatch_id FROM sd_despatch where despatch_id = '$numero' and sucursal = '$codigo_local' order by despatch_id desc";
                    //echo "3";
                }
            }
