    ...
    <form name="form1" id="form1">
        <section>
            ...
            <table class="table_2" style="width: 100%;" frame="hsides" rules="groups">
                ...
                $sqlDet = "SELECT  codProducto,nameProduct,deliveredQuantity,unitCode,amountPrice,amountTaxted,igvTax FROM sd_despatch_line where despatch_uid = '$despatch_uid'";
                    ...
                    <thead>
                        <tr>
                            ...
                            <?php if ($drogueria == 1) { ?>
                                ...
                                <th class="thra" style="width: 30px;">VENCI.</th>
            ...
            <TABLE class="table_2x"  style="border: 1px solid #00FF00; width: 100%;"  frame="hsides" rules="groups">-->
                    ...
                    <tbody class="lista_productos">
                        ...
                        while ($row = mysqli_fetch_array($resultDet)) {
                            ...
                            // $sql = "SELECT  FROM sd_despatch_line where despatch_uid = '$despatch_uid'";
                            ...
                            // $sql = "SELECT sum(igvTax) FROM sd_despatch_line where despatch_uid = '$despatch_uid'";
                            ...
                            $vencimnnn = "";
                            $numlote = "";
                            $sql1_movlote = "SELECT numlote,vencim FROM movlote where codpro = '$codProducto'  and codloc= '$sucursal'  and stock <> 0 and date_format(str_to_date(concat('01/',vencim),'%d/%m/%Y'),'%Y-%m-%d') >= NOW() ORDER BY date_format(str_to_date(concat('01/',vencim),'%d/%m/%Y'),'%Y-%m-%d') limit 1";
