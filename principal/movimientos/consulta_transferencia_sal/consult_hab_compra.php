...
if (mysqli_num_rows($result)) {
    while ($row = mysqli_fetch_array($result)) {
        ...
        $sqlInsert = "INSERT INTO kardex (codpro, nrodoc, tipmov, tipdoc, invnum, qtypro, fecha, sucursal, eliminado, factor, sactual) VALUES('$codpro', '$numdoc', '1', '1', '$cod', '$cant_unid', '$fechaActual', '$sucursal', '3', '$factor', '$sactual')";
//		error_log($sqlInsert);
