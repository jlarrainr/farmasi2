 <form id="form1" name="form1" onKeyUp="highlight(event)" onClick="highlight(event)" enctype="multipart/form-data">
     ...
     <table width="100%" border="0" cellspacing="2" cellpadding="2">
         ...
         <tr>
             ...
             <td class="LETRA">¿Cuantas unidades vienen en el producto para la venta? (FACTOR)</td>
             <td>
         ...
         <tr>
             ...
             <td class="LETRA">¿Cuantas unidades contiene un blister?</td>
             <td>
                 <label>
         ...
         <tr>
             <td class="LETRA">¿A que laboratorio o marca pertenece?</td>
             <td>
                 <label>
         ...
         <tr>
             <td class="LETRA">¿Cual es su principio activo? </td>
             <td>
                 <label>
         ...
         <tr>
             <td class="LETRA">¿Cual es su accion terapeutica?</td>
             <td>
                 <label>
         ...
         <tr>
             <td class="LETRA">Seleccione su presentacion</td>
             <td><label>
         ...
         <tr>
             <td class="LETRA">Seleccione su categoria</td>
             <td><label>
         ...
         <tr>
             <td class="LETRA">Codigo Producto - Digemid </td>
             <td>
                 <label>
         ...
         <tr>
             <td class="LETRA">Codigo Generico - Digemid</td>
             <td>
                 <label>
         ...
         <tr>
             <td class="LETRA">Codigo de barras </td>
             <td>
                 <label>
         ...
         <tr>
             <td class="LETRA">CODIGO DE CUENTA </td>
             <td>
                 <label>
