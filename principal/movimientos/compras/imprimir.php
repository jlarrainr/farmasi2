...
<body onLoad="imprimirsss();">
<form name="form1" id="form1">
  <table width="98%" border="0" cellpadding="0" cellspacing="0">
      <td width="11%">&nbsp;</td>
      <td width="20%">&nbsp;</td>
      <td width="69%"><div align="right">N Documento (prueba 06/08) <?php echo $numdoc;?></div></td>
    </tr>
  </table>
  <table width="98%" border="0" cellpadding="0" cellspacing="0">
  <tr>
...
<table width="98%" border="0">
  <tr>
    <td width="6%">CantidadBJBJKBJBBJK</td>
...
<?php 
	...
	while ($row1 = mysqli_fetch_array($result1)){
		...
		$d2        = $row1['desc2'];
		$d3        = $row1['desc3'];
		$sqlx="SELECT desprod FROM producto where codpro = '$codpro'";
		$resultx = mysqli_query($conexion,$sqlx);
		if (mysqli_num_rows($resultx)){
		while ($rowx= mysqli_fetch_array($resultx)){
				$desprod       = $rowx['desprod'];		//codigo
				}}
?>
<table width="98%" border="0">
  <tr>
