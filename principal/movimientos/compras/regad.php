...
<head>
  ...
  ?>
  <link href="../../archivo/css/tablas.css" rel="stylesheet" type="text/css" />
          ...
          <table width="436" border="0">
            <tr>
              ...
              <td width="347">
                ...
                <input name="button" type="button" onclick="opener.copyForm4()" value="Grabar" class="grabar" />
              </td>
            </tr>
          </table>
        </td>
