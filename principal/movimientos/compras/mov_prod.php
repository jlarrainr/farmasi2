...
<head>
    ...
    if ($search == 1) {
        $sql = "SELECT codpro,desprod,codbar,factor,margene,stopro,moneda,prevta,imapro,detpro,cant1,cant2,cant3,desc1,desc2,desc3,activo,prelis,prevta,preuni,margene,costre,stopro,codmar,coduso,codfam,igv,incentivado,blister,$lotenombre as lote,codpres,activo1,costpr,utlcos,preblister,digemid,cod_generico,registrosanitario,covid,codcatp FROM producto where codpro = '$busqueda' and codpro <> 0 and eliminado = 0";
    } else {
        $sql = "SELECT codpro,desprod,codbar,factor,margene,stopro,moneda,prevta,imapro,detpro,cant1,cant2,cant3,desc1,desc2,desc3,activo,prelis,prevta,preuni,margene,costre,stopro,codmar,coduso,codfam,igv,incentivado,blister,$lotenombre as lote,codpres,activo1,costpr,utlcos,preblister,digemid,cod_generico,registrosanitario,covid,codcatp  FROM producto where codpro <> 0 and eliminado = 0 $limit";
    }
