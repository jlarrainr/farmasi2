...
$cod   = $_POST['cod'];		///CODIGO PRODUCTO
$numero= $_POST['numero'];		///CODIGO PRODUCTO
$invnum= $_POST['invnum'];		///CODIGO PRODUCTO
...
if ($number == 0)
{
mysqli_query($conexion,"UPDATE movmov set qtypro = '$text1', qtyprf ='', prisal = '$text2', desc1 = '$text3', desc2 = '$text4', desc3 = '$text5', pripro = '$text6', costre = '$text7',costpr= '$promedio' where invnum = '$invnum' and codpro = '$cod'");
}
else
{
mysqli_query($conexion,"UPDATE movmov set qtypro = '',qtyprf = '$text1', prisal = '$text2', desc1 = '$text3', desc2 = '$text4', desc3 = '$text5', pripro = '$text6', costre = '$text7',costpr= '$promedio' where invnum = '$invnum' and codpro = '$cod'");
}
$pagina	 = 'consult_compras.php?n=1&upd=1&numero='.$numero;
