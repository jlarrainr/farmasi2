    ...
    <div class="tabla1">
        ...
        <div class="title1">
            ...
            <table width="100%" border="0">
                <tr>
                    <td align="left">
                        <span class="titulos">Movimiento de Mercaderias - Consulta de Compras</span>
                    </td>
        ...
        <div class="mask1111">
            <div class="mask2222">
                <div class="mask3333">
                    <iframe src="consult_compras1.php?n=<?php echo $n ?>&upd=<?php echo $upd ?>&numero=<?php echo $numero ?>" name="iFrame1" width="100%" height="600" scrolling="Automatic" frameborder="0" id="iFrame1" allowtransparency="0">
                    </iframe>
                </div>
            </div>
        </div>
