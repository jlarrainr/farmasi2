			...
			<tr>
				<td width="958">
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="76" class="LETRA"><?php echo TEXT_NUMERO ?></td>
							...
							<td width="61" class="LETRA">
								<div align="right"><?php echo TEXT_FECHA ?></div>
							</td>
							<td width="129"><input class="LETRA2" name="textfield2" type="text" size="22" disabled="disabled" value="<?php echo fecha($fecha) ?>" />
							</td>
							<td width="700"><label>
									<div align="right">
										...
										<input name="save" type="button" id="save" value="<?php echo TEXT_GRABAR; ?>" onclick="grabar1()" class="grabar" <?php if (($count == 0) || ($count1 > 0)) { ?>disabled="disabled" <?php } ?> />
										<input name="ext" type="button" id="ext" value="<?php echo TEXT_CANCELAR; ?>" onclick="cancelar()" class="cancelar" />
									</div>
								</label></td>
						</tr>
					</table>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="76" class="LETRA"><?php echo TEXT_REFERENCIA; ?></td>
							<td>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="100%">
								<iframe src="salidas_varias_lote2.php" name="iFrame1" width="100%" height="250" scrolling="Automatic" frameborder="0" id="iFrame1" allowtransparency="0">
								</iframe>
							</td>
						</tr>
						<tr>
							<td width="100%">
								<iframe src="salidas_varias_lote3.php" name="iFrame2" width="100%" height="298" scrolling="Automatic" frameborder="0" id="iFrame2" allowtransparency="0"> </iframe>
							</td>
						</tr>
					</table>
