...
<body bgcolor="#f7f7f7">
  ...
  $sql1 = "SELECT V.invnum,V.numero_documento,V.numero_documento1, VC.fechaplazo, VC.tipoDocumento, VC.id_cuota, VC.formaPago, VC.montoPago, VC.usuario, VC.hora, VC.codigoCliente, VC.fechapago, VC.banco, VC.nrobanco, VC.saldo_deuda,VC.textoCuota,VC.montoTotal FROM cuentaPorPagarDetalle AS VC   INNER JOIN movmae AS V ON V.invnum=VC.id_cuota         where V.invnum = '$id' order by invnum desc";
