        ...
        <div class="tabla1">
            ...
            <div class="title1">
                ...
                <table width="100%" border="0">
                    <tr>
                        <td align="left">
                            <span class="titulos">Devolucion en Buen Estado</span>
                        </td>
            ...
            <div class="mask1111">
                <div class="mask2222">
                    <div class="mask3333">
                        ...
                        <iframe src="devolucion1.php" name="iFrame1" width="100%" height="700" scrolling="Automatic" frameborder="0" id="iFrame1" allowtransparency="0">
                        </iframe>
                    </div>
                </div>
            </div>
