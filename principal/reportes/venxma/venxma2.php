            ...
            <tr>
                <td><table width="914" border="0">
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><div align="center"><strong>FECHA: <?php echo date('d/m/Y'); ?> - HORA : <?php echo $hour; ?>:<?php echo $min; ?> <?php echo $hor ?></strong></div></td>
                        </tr>
                        <tr>
                            ...
                            <td width="30">&nbsp;</td>
                            <td width="284"><div align="center">USUARIO:<span class="text_combo_select"><?php echo $user ?></span> </div></td>
                        </tr>
        ...
        if ($val == 1) {
            ...
            <?php if ($ven == 2) { ?>
                ...
                <table width="1390" border="1" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <th width="29"><strong>N&ordm;</strong></th>
                        <th width="170"><strong>PRODUCTO</strong></th>

                        <th width="45"><strong>MARCA</strong></th>
                        <?php if ($doc == 1) { ?><th width="50"><div align="center"><strong>UND V.</strong></div></th><?php } ELSEif ($doc == 3) { ?><th width="56"><div align="center"><strong>UND V.</strong></div></th><?php } ?>
                        <?php if ($doc == 2) { ?><th width="50"><div align="center"><strong></strong></div></th><?php } ELSEIF ($doc == 3) { ?><th width="56"><div align="center"><strong></strong></div></th><?php } ?>


                        <th style="font-size:10px" width="40"><div align="center"><strong><?php if ($nombre1 == "") { ?>LOCAL0<?php
                                    } else {
                                        echo $nombre1;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre2 == "") { ?>LOCAL1<?php
                                    } else {
                                        echo $nombre2;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre3 == "") { ?>LOCAL2<?php
                                    } else {
                                        echo $nombre3;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre4 == "") { ?>LOCAL3<?php
                                    } else {
                                        echo $nombre4;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre5 == "") { ?>LOCAL4<?php
                                    } else {
                                        echo $nombre5;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre6 == "") { ?>LOCAL5<?php
                                    } else {
                                        echo $nombre6;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre7 == "") { ?>LOCAL6<?php
                                    } else {
                                        echo $nombre7;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre8 == "") { ?>LOCAL7<?php
                                    } else {
                                        echo $nombre8;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre9 == "") { ?>LOCAL8<?php
                                    } else {
                                        echo $nombre9;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre10 == "") { ?>LOCAL9<?php
                                    } else {
                                        echo $nombre10;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre11 == "") { ?>LOCAL10<?php
                                    } else {
                                        echo $nombre11;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre12 == "") { ?>LOCAL11<?php
                                    } else {
                                        echo $nombre12;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre13 == "") { ?>LOCAL12<?php
                                    } else {
                                        echo $nombre13;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre14 == "") { ?>LOCAL13<?php
                                    } else {
                                        echo $nombre14;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre15 == "") { ?>LOCAL14<?php
                                    } else {
                                        echo $nombre15;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre16 == "") { ?>LOCAL15<?php
                                    } else {
                                        echo $nombre16;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre17 == "") { ?>LOCAL16<?php
                                    } else {
                                        echo $nombre17;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre18 == "") { ?>LOCAL17<?php
                                    } else {
                                        echo $nombre18;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre19 == "") { ?>LOCAL18<?php
                                    } else {
                                        echo $nombre19;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre20 == "") { ?>LOCAL19<?php
                                    } else {
                                        echo $nombre20;
                                    }
                                    ?></strong></div></th>
                        <th style="font-size:10px" width="40" ><div align="center"><strong><?php if ($nombre21 == "") { ?>LOCAL20<?php
                                    } else {
                                        echo $nombre21;
                                    }
                                    ?></strong></div></th>
                        <th width="50"><div align="center"><strong>TOTAL</strong></div></th>
                    </tr>
                    ...
                    if (mysqli_num_rows($result1)) {
                        while ($row1 = mysqli_fetch_array($result1)) {
                            ...
                            $sql2 = "SELECT codpro,desprod,codmar,codfam,factor,margene,costre,costpr,s000,s001,s002,s003,s004,s005,s006,s007,s008,s009,s010,s011,s012,s013,s014,s015,s016,s017,s018,s019,s020,SUM(s000+s001+s002+s003+s004+s005+s006+s007+s008+s009+s010+s011+s012+s013+s014+s015+s016+s017+s018+s019+s020) as suma FROM producto where codpro = '$codpro' and eliminado='0'";
                            $result2 = mysqli_query($conexion, $sql2);
                            if (mysqli_num_rows($result2)) {
                            ...
                            <tr>
                                ...
                                <td width="160"><div ><?php echo $product ?></div></td>
                                <td width="55"><div align="center"><?php echo $destab ?></div></td>
                                ...
                                <td width="35"><div align="center"><?php echo $s000 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s001 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s002 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s003 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s004 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s005 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s006 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s007 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s008 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s009 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s010 ?></div></td>
                                <td width="40"><div align="center"><?php echo $s011 ?></div></td>
                                <td width="40"><div align="center"><?php echo $s012 ?></div></td>
                                <td width="40"><div align="center"><?php echo $s013 ?></div></td>
                                <td width="35"><div align="center"><?php echo $s014 ?></div></td>
                                <td width="40"><div align="center"><?php echo $s015 ?></div></td>
                                <td width="40"><div align="center"><?php echo $s016 ?></div></td>
                                <td width="40"><div align="center"><?php echo $s017 ?></div></td>
                                <td width="40"><div align="center"><?php echo $s018 ?></div></td>
                                <td width="40"><div align="center"><?php echo $s019 ?></div></td>
                                <td width="40"><div align="center"><?php echo $s020 ?></div></td>

                                <td width="40"><div align="center"><?php echo $suma ?></div></td>
            ...
            <?php } else { ?>
                ...
                <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <th width="60"><strong>N&ordm;</strong></th>
                        <th width="370"><strong>PRODUCTO</strong></th>
                        <th width="45"><strong>MARCA</strong></th>
                        <?php if ($doc == 1) { ?><th width="80"><div align="center"><strong>UND V.</strong></div></th><?php } ELSEif ($doc == 3) { ?><th width="80"><div align="center"><strong>UND V.</strong></div></th><?php } ?>
                        <?php if ($doc == 2) { ?><th width="80"><div align="center"><strong></strong></div></th><?php } ELSEIF ($doc == 3) { ?><th width="80"><div align="center"><strong></strong></div></th><?php } ?>
...
//                                     $contador++
                                    ?>
                                    <th width="40"><strong> <?php echo $abrev; ?></strong></th>
                                    <?php
                                    $contador++;
                                }
                            }
                    ...
                    <tr>
                        ...
                        if (mysqli_num_rows($result1)) {
                            while ($row1 = mysqli_fetch_array($result1)) {
                                ...
                                <td width="20"><?php echo $i ?></td>
                                <td width="160"><div align="center"><?php echo $product ?></div></td>
                                <td width="55"><div align="center"><?php echo $abrev ?></div></td>
                                <?php if ($doc == 1) { ?><td width="45">  <?php echo $canpro ?></td><?php } ELSEif ($doc == 3) { ?><td width="45">  <?php echo $canpro ?></td><?php } ?>
                                <?php if ($doc == 2) { ?><td width="45"> <?php echo "S/" . $SOLES; ?> </td><?php } ELSEif ($doc == 3) { ?><td width="45"> <?php echo "S/" . $SOLES; ?> </td><?php } ?>
