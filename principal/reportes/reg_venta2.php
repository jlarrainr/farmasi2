...
/////tipo de documento
if ($doc == 1) {
    $tipodocumento = "POR BOLETA";
}
if ($doc == 2) {
    $tipodocumento = "POR FACTURA";
}
if ($doc == 3) {
    $tipodocumento = "POR TICKET";
}
if ($doc == 4) {
    $tipodocumento = "POR NOTA DE CREDITO";
}

if ($doc == 5) {
    $tipodocumento = "POR BOLETAS Y FACTURAS";
}
?>
<?php
$hour = date('G');
...
?>
<script>
    function printerpdf2uno(Valor, a) {

        window.open('pdfre2.php?venta=' + Valor + '&doc=' + a, 'venta_principal');
    }

    function pdfre2print(Valor) {

        window.open('pdfre2print.php?venta=' + Valor, 'venta_principal');
    }

    function printerpdf2unoA4(Valor, a) {

        window.open('pdfre2A4.php?venta=' + Valor + '&doc=' + a, 'venta_principal');

    }
    /* function printerpdf2unoA42(Valor) {
     
     window.open('pdfre2A42.php?venta=' + Valor, 'venta_principal');
     }*/

    function printerpdf2unoA42(valor, a) {
        var valor;
        var opciones = "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=yes, width=1000, height=900, top=100, left=100";
        window.open("pdfre2A42.php?venta=" + valor + '&doc=' + a, "", opciones);
        return false;
    }
</script>
