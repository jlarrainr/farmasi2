                                            ...
                                            <table  align="center" style="border: solid 1px;width:98%;height:100%;margin: 25px;  " id="tabDetalle" name="tabDetalle" cellpadding="0" cellspacing="0">
                                                <thead>
                                                    <tr style="border: solid 1px;">
                                                        ...
                                                        <th style="border: solid 1px;width:5%;">Codigo</th>
                                                        <th style="border: solid 1px;width:15%;">Producto</th>
                                                        <th style="border: solid 1px;width:10%;" >Laboratorio</th>
                                                        <th style="border: solid 1px;width:5%;">Factor</th>
                                                        
                                                        <!-- <th style="border: solid 1px;width:10%;" >Stock Almacen/Central</th> -->
                                                        <th style="border: solid 1px;width:10%;" >Stock Sucursal</th>
                                                        <th style="border: solid 1px;width:5%;" >Solicitado</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    ...
                                                    if (mysqli_num_rows($result)) {
                                                        while ($row = mysqli_fetch_array($result)) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="border: solid 1px;padding:1px"><?php echo $codpro; ?></td>
                                                                ...
                                                                <!-- <td style="border: solid 1px;padding:1px"><?php echo stockcaja($stocentral, $factor);  ?></td> -->

                                                               
                                                               
                                                               
                                                                 <td style="border: solid 1px;padding:1px"><?php echo stockcaja($stocentpro, $factor);  ?></td>
