...
$date = date('d/m/Y');
$hour1 = date("G:i");
$hour = date("g:i a", strtotime($hour1));
?>
...
<table width="99%" border="0" align="center" id="customers">
    ...
    if ($ck == 1) {
        ...
        if ($vendedor != 'all') {
            $sql1 = "SELECT *  FROM arqueo_caja  WHERE codigo_usuario ='$vendedor' and fecha_inicio BETWEEN '$date1' and '$date2'   and fecha_inicio<>'$fecha_actual'   and fecha_inicio <> fecha_cierre ";
        } else {
            $sql1 = "SELECT *  FROM arqueo_caja  WHERE     fecha_inicio BETWEEN '$date1' and '$date2' and fecha_inicio<>'$fecha_actual'  and fecha_inicio <> fecha_cierre";
        }
    } else {
    ...
    ?>
        <thead>
            <tr>
                <!-- <th colspan="8" style="font-size: 15px;"> Detalle de Cierre de Caja</th> -->
                <!-- <th colspan="4" style="font-size: 15px;"> Monto Total de Venta </th> -->
            </tr>
            <tr>
