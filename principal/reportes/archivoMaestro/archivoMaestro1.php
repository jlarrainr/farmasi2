...
<head>
    ...
    <script language="JavaScript">
        function buscar() {
            ...
            if (tip == 1) {
                f.action = "archivoMaestro1.php";
            } else {
                f.action = "archivoMaestro_excel.php";
            }
            f.submit();
        }
...
<body>
    <table width="100%" border="0">
        <tr>
            <td><b><u>REPORTE POR archivoMaestro </u></b>
                <form id="form1" name="form1" method="post" action="">
                    <table width="100%" border="0" class="tablarepor">
                        ...
                        <tr>
                            ...
                            <td class="LETRA" align="right">HASTA</td>
                            <td  >
                                <?php //echo $marca2
                                ?>
