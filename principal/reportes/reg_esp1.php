                    ...
                    <form id="form1" name="form1" method = "post" action="">
                        <table class="tablarepor"  width="100%" border="0">
                            <tr>
                                ...
                                <td width="30" align="right" class="LETRA">TIPO</td>
                                <td width="150">
                        ...
                        <!--                <option value="3" <?php if ($doc == 3) { ?> selected="selected"<?php } ?>>POR TICKET</option>-->
                                ...
                                <td width="15"><div align="right" class="LETRA">LOCAL</div></td>
                                <td width="55" >
...
<!--			<input name="ckprod" type="checkbox" id="ckprod" value="1" <?php if ($ckprod == 1) { ?>checked="checked"<?php } ?> onclick="desab()"/>
        ...
        <!--                                  <td width="220"><input name="val3" type="hidden" id="val3" value="3" />
                            ...
                            <tr>
                                ...
                                <td width="119" class="LETRA">NRO DE VENTA INICIAL</td>
                                ...
                                <td width="50" class="LETRA"><div align="right">NRO DE VENTA FINAL</div></td>
                                <td  colspan="3"width="133"><input name="desc1" type="text" id="desc1" onkeypress="return acceptNum(event)" size="8" maxlength="8" value="<?php echo $desc1 ?>"/>            </td>
                                <!--<td width="23">&nbsp;</td>-->
                                <td width="199">
                            ...
                            <tr>
                                ...
                                <td width="120" class="LETRA"><div align="right">FECHA FINAL</div></td>
                                ...
                                <td colspan="2" width="220"><input name="vals" type="hidden" id="vals" value="2" />
