    ...
    <div class="tabla1">
        ...
        <div class="title1">
            ...
            <table width="100%" border="0">
                <tr>
                    <td align="left">
                        <span class="titulos">REPORTE REGISTROS DE PRODUCTOS</span>
                    </td>
        ...
        <div class="mask1111">
            <div class="mask2222">
                <div class="mask3333">
                    <iframe src="mov_producto1.php" name="principal" width="100%" height="600" scrolling="Automatic" frameborder="0" id="principal" allowtransparency="0">
                    </iframe>
                </div>
            </div>
        </div>
