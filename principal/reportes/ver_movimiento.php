...
<body>
  ...
  <table width="100%" border="0" bgcolor="#d9d9d9">
    ...
    <tr>
      <td width="33%">
        <div align="center">
          <strong>VALOR COMPRA : </strong><input name="mont1" class="sub_totales" type="text" id="mont1" onclick="blur()" size="15" value=" <?php echo $suma_valor_compra; ?> " />
        </div>
      </td>
      <td width="33%">
        <div align="center">
          <strong>IGV : </strong><input name="mont4" class="sub_totales" type="text" id="mont4" onclick="blur()" size="15" value="<?php echo $suma_igv; ?> " />
        </div>
      </td>
      <td width="33%">
        <div align="center">
          <strong>TOTAL : </strong><input name="mont5" class="monto_tot" type="text" id="mont5" onclick="blur()" size="8" value="<?php echo $suma_total; ?>" />
        </div>
      </td>
    </tr>
  </table>
