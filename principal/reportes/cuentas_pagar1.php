...
<body>
                        ...
                        <tr>
                            ...
                            <td width="365">
                                <select name="tipo" id="tipo">
                                    ...
                                    <option value="4" <?php if ($tipo == 4) { ?> selected="selected" <?php } ?>>CUENTAS POR PAGAR</option>
                                    <option value="5" <?php if ($tipo == 5) { ?> selected="selected" <?php } ?>>CUENTAS PAGADAS</option>
                                </select>
                            </td>
    ...
    if (($val == 1) || ($vals == 2)) {
    ?>
        <iframe src="cuentas_pagar2.php?val=<?php echo $val ?>&tipo=<?php echo $tipo ?>&reporte=<?php echo $reporte ?>&date1=<?php echo $date1 ?>&date2=<?php echo $date2 ?>" name="marco" id="marco" width="100%" height="430" scrolling="Automatic" frameborder="0" allowtransparency="0">
        </iframe>
    <?php }
    ?>
</body>
