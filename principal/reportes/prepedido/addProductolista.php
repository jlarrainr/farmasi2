...
<head>
    ...
    <script>
        function SelecProducto(Valor) {
            ...
            f.method = "post";
            f.action = "addProducto.php?CProductoBonif=" + valor;
            f.submit();
    ...
    <form name="lista" id="lista">
        <table style="width: 100%" id="customers">
            ...
            if (is_numeric($ProductoBusk)) {
                $sql3 = "SELECT codpro,desprod,codmar,factor FROM producto where codbar = '$ProductoBusk' or codpro = '$ProductoBusk' and $utlcos_p>0 and eliminado='0' ";
            } else {
                $sql3 = "SELECT codpro,desprod,codmar,factor FROM producto where desprod like '$ProductoBusk%' and $utlcos_p >0 and eliminado='0' ";
            }
