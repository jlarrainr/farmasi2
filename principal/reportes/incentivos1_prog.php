...
$fecha = DateTime::createFromFormat('d-m-Y', $_GET["date1"]);
$fechaIniciod = $fecha->format('Y-m-d');


$fecha2 = DateTime::createFromFormat('d-m-Y', $_GET["date2"]);
$fechaFind = $fecha2->format('Y-m-d');

$sqlFechaDV = " AND (DV.invfec BETWEEN  '$fechaIniciod' AND  '$fechaFind' ) AND ";
$sqlFechaDetalleVenta = " AND (detalle_venta.invfec BETWEEN  '$fechaIniciod' AND  '$fechaFind' ) AND ";
$sqlFechaD = " AND (D.invfec BETWEEN  '$fechaIniciod' AND  '$fechaFind' ) AND ";
