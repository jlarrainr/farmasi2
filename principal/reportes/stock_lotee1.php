...
<script src="https://cdn.datatables.net/1.10.20/js/jquery.dataTables.min.js"></script>
        ...
        require_once("ajax_lotes.php"); //FUNCIONES DE AJAX PARA COMPRAS Y SUMAR FECHAS
        ?>
        ...
        <script language="JavaScript">
            ...
            function validar1()
            {
                ...
                if (tip == 1)
                {
                    f.action = "stock_lotee1.php";
                } else
                {
                    f.method = 'get';
                    f.action = "stock_loteeg.php";
                }
                f.submit();
            }
                    ...
                    <form id="form1" name="form1" method = "post" action="">
                        <table width="100%" border="0" class="tablarepor">
                            <tr>
                                ...
                                <td width="90" align="right" class="LETRA">TIPO BUSQUEDAD</td>
                                <td width="150">
                                    <select style="width:150px" name="doc" id="doc">

                                        <option value="3" <?php if ($doc == 3) { ?> selected="selected"<?php } ?>>SELECIONAR TODOS</option>
                                        <option value="1" <?php if ($doc == 1) { ?> selected="selected"<?php } ?>>POR PRODUCTO</option>
                                        <option value="2" <?php if ($doc == 2) { ?> selected="selected"<?php } ?>>POR MARCA</option>


                                    </select>            
                                </td>

                                <td width="40" class="LETRA"><div align="right">LOCAL</div></td>
                                <td width="450">
                        ...
                        <!--			<input name="ckloc" type="checkbox" id="ckloc" value="1" <?php if ($ckloc == 1) { ?>checked="checked"<?php } ?>/>
                                    ...
                                    <label for="ckprod"> <b>Productos por revisar</b></label>
                                </td>
...
<!--                                      <input type="button" name="Submit" value="RESUMEN X DIA" onclick="resumen()" class="buscar"/>-->
                                    <input type="button" name="Submit" value="TODOS LOS PRODUCTOS" onclick="validar3()" class="buscar"/>
                                ...
                                <td width="24">
                                    ...
                                    if (($pagina - 1) > 0) {
                                        ?>
                                        <a href="stock_lotee.php?country_ID=<?php echo $country_ID ?>&country=<?php echo $country ?>&val=<?php echo $val ?>&vals=<?php echo $vals ?>&desc=<?php echo $desc ?>&desc1=<?php echo $desc1 ?>&date1=<?php echo $date1 ?>&date2=<?php echo $date2 ?>&ck=<?php echo $ck ?>&ck1=<?php echo $ck1 ?>&ckloc=<?php echo $ckloc ?>&local=<?php echo $local ?>&inicio=<?php echo $inicio ?>&registros=<?php echo $registros ?>&pagina=<?php echo $pagina - 1 ?>"><img src="../../images/play1.gif" width="100%" height="16" border="0"/> </a>
                                    <?php }
                                    ?></td>
                                <td width="24"><?php
                                    if (($pagina + 1) <= $total_paginas) {
                                        ?>
                                        <a href="stock_lotee.php?country_ID=<?php echo $country_ID ?>&country=<?php echo $country ?>&val=<?php echo $val ?>&vals=<?php echo $vals ?>&desc=<?php echo $desc ?>&desc1=<?php echo $desc1 ?>&date1=<?php echo $date1 ?>&date2=<?php echo $date2 ?>&ck=<?php echo $ck ?>&ck1=<?php echo $ck1 ?>&ckloc=<?php echo $ckloc ?>&local=<?php echo $local ?>&inicio=<?php echo $inicio ?>&registros=<?php echo $registros ?>&pagina=<?php echo $pagina + 1 ?>"> <img src="../../images/play.gif" width="100%" height="16" border="0"/> </a>
                                    <?php }
                                    ?></td>
                            </tr>
                ...
                <!--                <td width="119">FECHA INICIO</td>
                                ...
                                <td width="50" class="LETRA"><div align="right">DESCRIPCION</div></td>
                                <td >
                                ...
                                <td colspan="4" width="220" align="right"><input name="vals" type="hidden" id="vals" value="2" />
