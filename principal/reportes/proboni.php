...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div class="tabla1">
            ...
            <div class="title1">
                <span class="titulos">SISTEMA DE VENTAS - PRODUCTOS BONIFICADOS
                </span></div>
            <div class="mask1111">
                <div class="mask2222">
                    <div class="mask3333">
                        <iframe src="proboni1.php" name="principal" width="100%" height="600" scrolling="Automatic" frameborder="0" id="principal" allowtransparency="0">
                        </iframe>
                    </div>
                </div>
            </div>
