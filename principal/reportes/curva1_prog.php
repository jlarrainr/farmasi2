...
<body>
    ...
    <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
		...
		where DV.invfec between '$date1' and '$date2' and DV.codpro = '$codpro' and V.sucursal = '$local' and V.val_habil = '0' and V.estado = '0'";
                                ...
                                if ($Tabla <> "0") {
                                    $sql1 = "SELECT desprod,codmar,$Tabla,factor, s000,costre,codfam,codpro FROM producto where codpro = '$codpro' and eliminado='0'";
                                } else {
                                    $sql1 = "SELECT desprod,codmar,stopro,factor, s000,costre,codfam,codpro FROM producto where codpro = '$codpro' and eliminado='0'";
                                }
                    ...
                    ?>
                                    <tr height="25" <?php if ($datDSDe2) { ?> bgcolor="#ff0000" <?php } else { ?>onmouseover="this.style.backgroundColor = '#FFFF99';this.style.cursor = 'hand';" onmouseout="this.style.backgroundColor = '#ffffff';" <?php } ?>>
                                        ...
                                        <td title="el factor es.<?php echo $factor; ?>"><?php echo $factor; ?></td>
                                        ...
                                        <?php if ($nlicencia > 1) { ?>
                                            <td width="169" align="center"><?php echo $div1 . " <strong>C</strong>" . " " . $UNI1; ?></td>

                                        <?php } ?>
                                        <td width="68">
                                            <div align="center"><?php echo $sum ?></div>
                                        </td>
                                        <td width="87" <?php if ($TipBusk == 1) { ?>class='Estilo1'><?php } ?><div align="left"><?php echo $sumcantidad1 ?></div>
                                        </td>
                                        <td width="58">
