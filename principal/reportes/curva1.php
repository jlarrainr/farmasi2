...
<body>
    <table width="100%" border="0">
        <tr>
            <td><b><u>REPORTE DE SUGERECIA DE COMPRAS</u></b>
                <form id="form1" name="form1" method="post" action="">
                    <table class="tablarepor" width="100%" border="0">
                        <tr>
                            ...
                            <td width="180">
                                <select name="TipBusk" id="TipBusk" style="width:200px;">
                                    <option <?php if ($TipBusk == 1) { ?>selected<?php } ?> value="1">Todos los productos vendidos</option>
                                    <!--<option <?php if ($TipBusk == 4) { ?>selected<?php } ?> value="4">Pron?stico de demanda(stock de seguridad x2)</option>
                                                    <option <?php if ($TipBusk == 3) { ?>selected<?php } ?> value="3">Compra m?nima sugerida</option>-->
                        ...
                        <tr>
                            ...
                            <!--<td width="199">&nbsp;</td>-->
                            <td colspan="4" width="250" align="right"><input name="val" type="hidden" id="val" value="1" />
                                <?php
                                if ($local != '' && $local != 'all') {
                                ?>
