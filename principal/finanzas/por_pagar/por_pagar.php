        ...
        <div class="tabla1">
            ...
            <div class="title1">
                ...
                <table width="100%" border="0">
                    <tr>
                        <td align="left">
                            <span class="titulos">Cuentas por Pagar a Proveedores</span>
                        </td>
            ...
            <div class="mask1111">
                <div class="mask2222">
                    <div class="mask3333">
                        ...
                        ?>
                        <iframe src="por_pagar1.php?activado=<?php echo $activado ?>&activado1=<?php echo $activado1 ?>&tipo=<?php echo $tipo ?>&val=<?php echo $val ?>&producto=<?php echo $producto ?>" name="venta_principal" width="100%" height="100%" scrolling="Automatic" frameborder="0" id="venta_principal" allowtransparency="0">
                        </iframe>
                    </div>
                </div>
            </div>
