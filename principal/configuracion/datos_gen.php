		...
		<table width="100%" border="0" align="center" height="100%">
			<tr>
				<td>
					<!--<br><br>-->
					<center>
						<iframe src="datos_gen1.php" name="iFrame1" width="100%" height="1500" scrolling="si" frameborder="No" id="iFrame1" allowtransparency="True"></iframe>
					</center>
				</td>
			</tr>
		</table>
